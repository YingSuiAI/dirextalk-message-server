...
var actionSpecs = []ActionSpec{
	...
	{Name: "rooms.reactivate", Auth: ActionAuthPublic, Transport: ActionTransportHTTPAndWS},
	...
	{Name: "channels.public.join_result", Auth: ActionAuthPublic, Transport: ActionTransportHTTPAndWS},

...
var actionSpecs = []ActionSpec{
	...
	{Name: "agent.web_search.test", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS},
	{Name: "agent.aws.credentials.test", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS},
	{Name: "agent.aws.approvals.execute", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS},
	{Name: "agent.aws.approvals.cancel", Auth: ActionAuthOwner, Transport: ActionTransportHTTPAndWS},

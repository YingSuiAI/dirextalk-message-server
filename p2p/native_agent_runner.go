...
func nativeAgentTools(service *Service) []nativeagent.Tool {
	return []nativeagent.Tool{
		...
		nativeAgentServiceTool("dirextalk_messages_list", "List ordinary messages in an allowed room.", nativeAgentObjectSchema(map[string]any{"room_id": nativeAgentStringSchema(), "from_ts": nativeAgentNumberSchema(), "to_ts": nativeAgentNumberSchema(), "limit": nativeAgentNumberSchema()}), service.mcpMessagesList),
		...
		nativeAgentServiceTool("dirextalk_channel_posts_list", "List channel posts.", nativeAgentObjectSchema(map[string]any{"room_id": nativeAgentStringSchema(), "from_ts": nativeAgentNumberSchema(), "to_ts": nativeAgentNumberSchema(), "limit": nativeAgentNumberSchema()}), service.mcpChannelPostsList),
		nativeAgentServiceTool("dirextalk_channel_comments_list", "List channel comments for a post.", nativeAgentObjectSchema(map[string]any{"post_id": nativeAgentStringSchema(), "from_ts": nativeAgentNumberSchema(), "to_ts": nativeAgentNumberSchema(), "limit": nativeAgentNumberSchema()}), service.mcpChannelCommentsList),

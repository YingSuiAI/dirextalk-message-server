...
import (
	...
	"github.com/YingSuiAI/direxio-message-server/clientapi/threepid"
...
func sendMembership(ctx context.Context, profileAPI userapi.ClientUserAPI, device *userapi.Device,
	...
	if err := productpolicy.ValidateClientMembership(ctx, rsAPI, productpolicy.ClientMembershipRequest{
		RoomID:     roomID,
		SenderMXID: device.UserID,
		TargetMXID: targetUserID,
		Membership: membership,
	}); err != nil {
		return productPolicyJSONResponse(ctx, err)
	}

This component roughly corresponds to "Client Room Send" and "Client Sync" on [the WIRING diagram](https://github.com/YingSuiAI/direxio-message-server/blob/master/WIRING.md).

...
func TestHTTPProfileResolverReturnsTrimmedProfile(t *testing.T) {
	...
	resolver := NewHTTPProfileResolver(server.URL+"/", server.Client())
	...
	if profile != (Profile{DisplayName: "liyanan7", AvatarURL: "mxc://t7/avatar"}) {
		t.Fatalf("unexpected profile: %#v", profile)
	}
}

func TestHTTPProfileResolverTreatsNotFoundAsEmptyProfile(t *testing.T) {

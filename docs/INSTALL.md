...
3. [Installing Dirextalk Message Server](installation/manual/1_build.md)
...
7. [Starting Dirextalk Message Server](installation/manual/5_starting_message_server.md)

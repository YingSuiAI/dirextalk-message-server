...
- Ordinary chat messages do not emit P2P outbox notifications. Clients receive ordinary message deltas from Matrix `/sync`; P2P SSE remains for product projections such as channel join requests and channel post/comment/reaction state.

...
7. Phase D: move lower-level adapters in dependency-safe order.
   ...
   - Next Phase D slice: add roomserver-backed history-visibility fixtures, then continue with narrower storage/projection boundaries.

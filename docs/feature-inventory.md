...
- Agent/MCP: `agent.config.get`, `agent.config.update`, `agent.password`, `mcp.rooms.search`, `mcp.messages.send`, `mcp.messages.list`, `mcp.channel_posts.list`, `mcp.channel_comments.list`, `mcp.channel_comments.create`

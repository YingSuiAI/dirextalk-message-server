...
type LocalEventHides interface {
	InsertLocalEventHides(ctx context.Context, txn *sql.Tx, userID, roomID string, eventIDs []string, hiddenAt string) error
	UpsertLocalRoomClear(ctx context.Context, txn *sql.Tx, userID, roomID string, throughStreamPos types.StreamPosition, hiddenAt string) error
	SelectLocalEventHideState(ctx context.Context, txn *sql.Tx, userID, roomID string, eventIDs []string) (types.LocalEventHideState, error)
	PurgeLocalEventHides(ctx context.Context, txn *sql.Tx, roomID string) error
}

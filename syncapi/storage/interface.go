...
type DatabaseTransaction interface {
	...
	FilterLocalHiddenStreamEvents(ctx context.Context, userID, roomID string, events []types.StreamEvent) ([]types.StreamEvent, error)
	FilterLocalHiddenEvents(ctx context.Context, userID, roomID string, events []*rstypes.HeaderedEvent) ([]*rstypes.HeaderedEvent, error)
}
...
type Database interface {
	...
	HideLocalEvents(ctx context.Context, userID, roomID string, eventIDs []string) error
	ClearLocalRoom(ctx context.Context, userID, roomID string, throughStreamPos types.StreamPosition) error
	SelectMemberships(
		ctx context.Context,

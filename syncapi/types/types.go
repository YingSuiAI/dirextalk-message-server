...
type LocalEventHideState struct {
	EventIDs            map[string]struct{}
	ClearStreamPosition StreamPosition
}

func (s LocalEventHideState) IsHidden(event StreamEvent) bool {
	...
	return s.ClearStreamPosition > 0 && event.StreamPosition <= s.ClearStreamPosition
}

...
func TestServiceReadinessPersistsOnlyChallengeDigestAndFencesEvidence(t *testing.T) {
	...
	task := ServiceReadinessRecord{ConnectionID: "connection-ready-0001", DeploymentID: "deployment-ready-0001", ServiceID: "service-ready-0001", TaskID: "readiness-task-0001", RequestSHA256: strings.Repeat("f", 64), BootstrapSessionID: "bootstrap-ready-0001", ExpectedInstanceID: "i-0123456789abcdef0", ExecutionID: "execution-ready-0001", ProbeKind: "stack_witnessed_fixed_worker_probe_v1", RecipeExecutionManifestDigest: digest("a"), InstallEvidenceDigest: digest("b"), SemanticExpectationDigest: digest("c"), Status: "running", Checkpoint: "challenge_issued", Attempt: 1, LeaseEpoch: 3, ChallengeDigest: digest("d"), ChallengeExpiresAt: "2026-07-15T12:02:00.000Z", CreatedAt: "2026-07-15T12:00:00.000Z", UpdatedAt: "2026-07-15T12:00:00.000Z"}

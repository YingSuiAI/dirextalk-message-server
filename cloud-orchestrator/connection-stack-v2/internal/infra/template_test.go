...
func TestTemplateKeepsTypedMutationBehindDisabledByDefaultGate(t *testing.T) {
	...
	for _, required := range []string{
		...
		"S3ObjectVersion: !Ref BrokerArtifactVersion",
		"AWS::DynamoDB::Table",
		...
		"DIREXTALK_WORKER_SECURITY_GROUP_ID: !Ref WorkerSecurityGroupId",
		"security-group/${WorkerSecurityGroupId}",

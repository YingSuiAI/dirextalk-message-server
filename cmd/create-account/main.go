...
Example:
	...
	# provide password by parameter
  	%s --config message-server.yaml -username alice -password foobarbaz
	# use password from file
  	%s --config message-server.yaml -username alice -passwordfile my.pass
	# ask user to provide password
	%s --config message-server.yaml -username alice
	# read password from stdin
	%s --config message-server.yaml -username alice -passwordstdin < my.pass
	cat my.pass | %s --config message-server.yaml -username alice -passwordstdin

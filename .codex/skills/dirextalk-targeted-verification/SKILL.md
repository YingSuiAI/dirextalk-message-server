---
name: dirextalk-targeted-verification
description: Choose focused Dirextalk Message Server verification after modifying Go code, routes, contracts, docs, Postman JSON, Docker/compose files, scripts, storage migrations, event/state flows, setup/config, or project-local skills.
---

# Dirextalk Targeted Verification
...
- Postman collection: validate `docs/postman/dirextalk-message-server.postman_collection.json` with `json.tool`.
